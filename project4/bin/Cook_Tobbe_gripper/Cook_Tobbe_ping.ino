...
void setup() {
  ...
  // Orient PING to the right. Detect distance in inches. If less than 72, record distance as cmd[1] to conform with pathing document.
